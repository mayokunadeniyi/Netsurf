...
public class Tab1 extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState){
        ...
        DataImage = (ImageView) getView().findViewById(R.id.Data_id);
        DataImage.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent mainIntent = new Intent(getActivity(), CheckBalanceActivity.class);
                startActivity(mainIntent);

            }

        });
        BuyImage = (ImageView) getView().findViewById(R.id.buy_id);
        BuyImage.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent mainIntent = new Intent(getActivity(), BuyDataActivity.class);
                startActivity(mainIntent);

            }

        });
        ShareImage = (ImageView) getView().findViewById(R.id.sharedata_id);
        ShareImage.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent mainIntent = new Intent(getActivity(), ShareDataActivity.class);
                startActivity(mainIntent);

            }

        });
        ChangeImage = (ImageView) getView().findViewById(R.id.password_change);
        ...
        SettingsImage = (ImageView) getView().findViewById(R.id.settings);
        ...
        LoginImage = (ImageView) getView().findViewById(R.id.Login_his);
        LoginImage.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent mainIntent = new Intent(getActivity(), LoginHistoryActivity.class);
                startActivity(mainIntent);
